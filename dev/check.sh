...
SUITES=(geometry glow glow-bottom keys media contract menu menu-replace colours design motion windows update surface plugins setup platform hosting notifications)
